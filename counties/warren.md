...
{% assign county = "warren" %}
{% assign county2 = "Warren" %}
{% assign founded = "1824, from Sussex County" %}
{% assign area = "363 square miles" %}
{% assign population = "28,433 (1860); 108,692 (2010)" %}
{% assign county_seat = "Belvidere" %}
{% assign largest_city = "Phillipsburg" %}
{% include county.html %}
...
<h1 class="fancy">1874: County Atlas</h1>

{% assign dir = "warren" %}
{% assign id = "1874-title-page" %}
{% assign title = "Title page. F. W. Beers. County Atlas of Warren, New Jersey: From Actual Surveys (New York: F. W. Beers & Co. . . . , 1874) [Historic Maps Collection]. 92 pp., including maps." %}
...
{% assign title = "2013: First Presbyterian Church. This is the second church building on the site, begun in 1870, with renovations and additions through 2008." %}
{% include figure-left.html %}
...
---
<div class="footnotes">
    <small><sup id="1">1</sup> Arthur T. Hamlin, <em>Blair Academy: A Sesquicentennial History</em> (1991), quoted from the home page of Blair Academy: <a href="http://www.blair.edu/about-blair/history-of-the-academy/index.aspx">(http://www.blair.edu/about-blair/history-of-the-academy/index.aspx)</a> (accessed September 2013).</small>
</div>