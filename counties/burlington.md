...
{% assign county = "burlington" %}
{% assign county2 = "Burlington" %}
{% assign founded = "1694" %}
{% assign area = "820 square miles—the only county that bridges the width of the state, from the Delaware River to the Atlantic Ocean" %}
{% assign population = "49,730 (1860); 448,734 (2010)" %}
{% assign county_seat = "Mount Holly" %}
{% assign largest_city = "Evesham Township" %}
{% include county.html %}
...
{% assign title = "2013: View from the top of the fire tower on Apple Pie Hill. A canopy of pine trees stretches in every direction, as far as the horizon." %}
...
{% assign title = "James D. Scott. Combination Atlas Map of Burlington County, New Jersey: Compiled, Drawn and Published from Personal Examinations and Surveys (Philadelphia: J. D. Scott, 1876) [Historic Maps Collection]. 88 pp., including illustrations and maps." %}
{% include figure-left.html %}
{% assign dir = "burlington" %}
{% assign id = "1876-burlington-county-map" %}
{% assign title = "&quot;Outline Plan of Burlington Co New Jersey.&quot; Lithograph map, with added color, 40.8 × 30.3 cm. Scale: 3 miles to 1 inch." %}
...
{% assign title = "&quot;Little Egg Harbor [Township].&quot; Lithograph map, with added color, 38 × 30.5 cm. Scale: 1 mile to 1 inch. The sheet also contains town plans of Herman City and Green Bank (Washington Township) and Lower Bank (Randolph Township)." %}
{% include figure-right.html %}
...
{% assign title = "&quot;Mount Holly.&quot; Lithograph map, with added color, 37.7 × 39.8 cm. Scale: 200 feet to 1 inch." %}
{% include figure-right.html %}
...
{% assign dir = "burlington" %}
{% assign id = "2013-mount-holly-1752-firehouse" %}
...
{% assign dir = "burlington" %}
{% assign id = "1876-bordentown-female-college" %}
...
{% assign dir = "burlington" %}
{% assign id = "2013-florence-trall-site-safe" %}
{% assign title = "2013:Rusted shell of a nineteenth-century safe found in the woods there." %}
{% include figure.html %}
